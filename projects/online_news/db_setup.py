...
DATA_CSV_ARTICLES = 'assets/data/articles.csv'
DATA_CSV_ARTICLES = os.path.join(os.path.dirname(__file__), DATA_CSV_ARTICLES)

# Attempt to run the DDLs
run_sql(DB_PARAMS, DDL_SQL_SCRIPT)

# Attempt to insert data
csv_to_table(DB_PARAMS, DATA_CSV_ARTICLES, 'articles')
